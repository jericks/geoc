...
//        String json = cmd.writePyramid(Pyramid.createGlobalMercatorPyramid())
//        Pyramid p = cmd.readPyramid(json)
//        println p

        // MBTiles
//        GenerateOptions options = new GenerateOptions(
//                tileLayer: new File("/Users/jericks/Desktop/countries.mbtiles"),
//                tileLayerName: "countries",
//                baseMap: new File("/Users/jericks/Projects/GISData/110m_cultural/ne_110m_admin_0_countries.shp"),
//                startZoom: 0,
//                endZoom: 4,
//                verbose: true
//        )
//        cmd.execute(options)
        ...
        // GeoPackage
//        GenerateOptions options = new GenerateOptions(
//                tileLayer: new File("/Users/jericks/Desktop/countries.gpkg"),
//                tileLayerName: "countries",
//                baseMap: new File("/Users/jericks/Projects/GISData/110m_cultural/ne_110m_admin_0_countries.shp"),
//                startZoom: 0,
//                endZoom: 4,
...
//        cmd.execute(options)
        ...
        // TMS
//        GenerateOptions options = new GenerateOptions(
//                tileLayer: new File("/Users/jericks/Desktop/countries"),
//                tileLayerName: "countries",
//                baseMap: new File("/Users/jericks/Projects/GISData/110m_cultural/ne_110m_admin_0_countries.shp"),
//                startZoom: 0,
//                endZoom: 4,
...
//        cmd.execute(options)
        ...
        GenerateOptions options = new GenerateOptions(
                type: "utfgrid",
                tileLayer: new File("/Users/jericks/Desktop/countries_utfgrid"),
                tileLayerName: "countries",
                baseMap: new File("/Users/jericks/Projects/GISData/110m_cultural/ne_110m_admin_0_countries.shp"),
                startZoom: 0,
                endZoom: 4,
...
//        GenerateOptions options = new GenerateOptions(
//                type: "mvt",
//                tileLayer: new File("/Users/jericks/Desktop/countries_mvt"),
//                tileLayerName: "countries",
//                baseMap: new File("/Users/jericks/Projects/GISData/110m_cultural/ne_110m_admin_0_countries.shp"),
//                startZoom: 0,
//                endZoom: 4,
...
//        GenerateOptions options = new GenerateOptions(
//                type: "pbf",
//                tileLayer: new File("/Users/jericks/Desktop/countries_pbf"),
//                tileLayerName: "countries",
//                baseMap: new File("/Users/jericks/Projects/GISData/110m_cultural/ne_110m_admin_0_countries.shp"),
//                startZoom: 0,
//                endZoom: 4,
